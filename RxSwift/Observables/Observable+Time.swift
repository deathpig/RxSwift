...
extension ObservableType {
    ...
    */
    // @warn_unused_result(message:"http://git.io/rxs.uo")
    public func buffer(_ timeSpan: RxTimeInterval, count: Int, scheduler: SchedulerType)
        -> Observable<[E]> {
...
extension ObservableType {
     ...
     */
    // @warn_unused_result(message:"http://git.io/rxs.uo")
    public func window(_ timeSpan: RxTimeInterval, count: Int, scheduler: SchedulerType)
