...
extension CLLocationManagerTests {
    func testDidUpdateLocations() {
        ...
        autoreleasepool {
            ...
            _ = manager.rx_didUpdateLocations.subscribe({ l in
                    location = l[0]
                }, onCompleted: {
                    completed = true
                })
    ...
    func testDidFailWithError() {
        ...
        autoreleasepool {
            ...
            _ = manager.rx_didFailWithError.subscribe({ e in
                error = e
                }, onCompleted: {
                    completed = true
                })
    ...
    func testDidFinishDeferredUpdatesWithError() {
        ...
        autoreleasepool {
            ...
            _ = manager.rx_didFinishDeferredUpdatesWithError.subscribe({ e in
                error = e
                }, onCompleted: {
                    completed = true
            })
    ...
    func testDidPauseLocationUpdates() {
        ...
        autoreleasepool {
            ...
            _ = manager.rx_didPauseLocationUpdates.subscribe({ u in
                    updates = u
                }, onCompleted: {
                    completed = true
            })
    ...
    func testDidResumeLocationUpdates() {
        ...
        autoreleasepool {
            ...
            _ = manager.rx_didResumeLocationUpdates.subscribe({ _ in
                    updates = ()
                }, onCompleted: {
                    completed = true
            })
    ...
    func testDidUpdateHeading() {
        ...
        autoreleasepool {
            ...
            _ = manager.rx_didUpdateHeading.subscribe({ n in
                    heading = n
                }, onCompleted: {
                    completed = true
            })
    ...
    func testDidEnterRegion() {
        ...
        autoreleasepool {
            ...
            _ = manager.rx_didEnterRegion.subscribe({ n in
                    value = n
                }, onCompleted: {
                    completed = true
                })
    ...
    func testDidExitRegion() {
        ...
        autoreleasepool {
            ...
            _ = manager.rx_didExitRegion.subscribe({ n in
                    value = n
                }, onCompleted: {
                    completed = true
                })
    ...
    func testDidDetermineStateForRegion() {
        ...
        autoreleasepool {
            ...
            _ = manager.rx_didDetermineStateForRegion.subscribe({ n in
    ...
    func testMonitorOfKnownRegionDidFailWithError() {
        ...
        autoreleasepool {
            ...
            _ = manager.rx_monitoringDidFailForRegionWithError.subscribe({ l in
                    region = l.region
                    error = l.error
                }, onCompleted: {
                    completed = true
    ...
    func testStartMonitoringForRegion() {
        ...
        autoreleasepool {
            ...
            _ = manager.rx_didStartMonitoringForRegion.subscribe({ n in
                    value = n
                }, onCompleted: {
                    completed = true
                })
    ...
    func testDidRangeBeaconsInRegion() {
        ...
        autoreleasepool {
            ...
            _ = manager.rx_didRangeBeaconsInRegion.subscribe({ n in
                    value = n
                }, onCompleted: {
                    completed = true
                })
    ...
    func testRangingBeaconsDidFailForRegionWithError() {
        ...
        autoreleasepool {
            ...
            _ = manager.rx_rangingBeaconsDidFailForRegionWithError.subscribe({ n in
                    value = n
                }, onCompleted: {
                    completed = true
                })
    ...
    func testDidVisit() {
        ...
        autoreleasepool {
            ...
            _ = manager.rx_didVisit.subscribe({ n in
                    value = n
                }, onCompleted: {
                    completed = true
                })
    ...
    func testDidChangeAuthorizationStatus() {
        ...
        autoreleasepool {
            ...
            _ = manager.rx_didChangeAuthorizationStatus.subscribe({ status in
